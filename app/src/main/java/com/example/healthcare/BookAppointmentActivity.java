    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.addOrder(username,ed1.getText().toString(),ed2.getText().toString(),ed3.getText().toString(),0,dateButton.toString(),timeButton.toString(),Float.parseFloat(ed4.toString()),"lab");
                ...
                if(db.checkAppointmentExists(username,title+" => "+fullname,address,contact,dateButton.getText().toString(),timeButton.getText().toString())==1){
                    ...
                    db.addOrder(username,title+" => "+fullname,address,contact,0,dateButton.getText().toString(),timeButton.getText().toString(),Float.parseFloat(fees.toString()),"medicine");
